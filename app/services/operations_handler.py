                        ...
                        if asset_type.asset_type_id in gcp_asset_list:
                            ...
                            if asset_type.asset_type_id == "bq_dataset" and hasattr(asset_type, 'assets'):
                                for asset in asset_type.assets:
                                    ...
                                    print(f'inside create_or_update_aspect')
                                    ...
                                    update_system_entry_bq_dataset(dataplex_project_id,
                                        dataplex_region,
                                        bigquery_project_id,
                                        bigquery_region,
                                        bigquery_dataset,
                            ...
                            #Creating/Updating Aspects under bq_table
                                ...
                                for asset in asset_type.assets:
                                    ...
                                    update_system_entry_bq_table(dataplex_project_id,
                                        dataplex_region,
                                        bigquery_project_id,
                                        bigquery_region,
                                        bigquery_dataset,
                            ...
                            #Creating/Updating Aspects under spn_schema
                                ...
                                for asset in asset_type.assets:
                                    ...
                                    update_system_entry_spn_schema(dataplex_project_id,
                                        dataplex_region,
                                        spanner_project_id,
                                        spanner_region,
                                        spanner_schema,
                            ...
                            #Creating/Updating Aspects under spn_table
                                ...
                                for asset in asset_type.assets:
                                    ...
                                    update_system_entry_spn_table(dataplex_project_id,
                                        dataplex_region,
                                        spanner_project_id,
                                        spanner_region,
                                        spanner_schema,
                            ...
                            #Creating/Updating Aspects under gcs_bucket
                                ...
                                for asset in asset_type.assets:
                                    ...
                                    update_system_entry_gcs_bucket(dataplex_project_id,
                                        dataplex_region,
                                        gcs_project_id,
                                        gcs_region,
                                        gcs_bucket,
